...
# 怎么样集中经验值去培养固定的英雄
* 通过每日的境界守卫可以把你不想得到经验值的那个英雄卸下来. 办法是在打开始打境界守卫关卡之前卸下来一个英雄. 然后点开始之后再取消战斗. 下次再进去境界守卫的时候你就是2个英雄了. 用同样的办法可以做到无英雄. 由于每张地图的经验值是固定的, 所以你越少的英雄打某个关卡, 你参战的英雄的经验值也就相对的能吃到更多.
# 游戏里的一些巨坑
