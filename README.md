...
2.圣水: 圣水的唯一用途就是用来升级英雄等级(英雄的等级作用请看[英雄升级的作用](#英雄升级的作用))和合成道具.圣水也是一种很重要的资源. 但是圣水到有大需求的时候是到了游戏大后期要打锦标赛的时候了, 所以是不建议玩家前期花费太多的钻石升级圣水工厂, 价值完全不等, 严重拖慢了推图的进度. 圣水要存起来投资到下一个购买的英雄身上来即可形成战斗力.
...
4.经验值： 经验值其实是另一种形态的圣水. 根据QQ名叫做1的群友提供的数据, 每个世界的关卡通关一星二星或者三星有不同的经验值奖励. 假如玩家1第一次通关为1星, 第二次通关3星的话将会为玩家1补齐3星跟1星中间的经验值差额. 三星通关将得到关卡的全道具奖励.  
